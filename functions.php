...
if ( ! function_exists( 'intuitive_setup' ) ) :
 ...
 function load_stylesheet()
 {
	...
	wp_enqueue_style('bootstrap');
	 ...
	 wp_register_style('touch',get_template_directory_uri() . '/assets/img/apple-touch-icon.png',array(),1,'all');
	 ...
	 wp_register_style('ionicons',get_template_directory_uri() . '/assets/vendor/ionicons/css/ionicons.min.css',array(),1,'all');
	 wp_enqueue_style('ionicons');

	 wp_register_style('venbox',get_template_directory_uri() . '/assets/vendor/venobox/venobox.css',array(),1,'all');
	 wp_enqueue_style('venbox');

	 wp_register_style('car',get_template_directory_uri() . '/assets/vendor/owl.carousel/assets/owl.carousel.min.css',array(),1,'all');
 ...
 function add_js()
 {
   ...
   wp_register_script('manu11',get_template_directory_uri() . '/assets/vendor/bootstrap/js/bootstrap.bundle.min.js',array(),1,1,1);
	...
	wp_register_script('manu14',get_template_directory_uri() . '/assets/vendor/jquery-sticky/jquery.sticky.js',array(),1,1,1);
	wp_enqueue_script('manu14');


	wp_register_script('manu15',get_template_directory_uri() . '/assets/vendor/venobox/venobox.min.js ',array(),1,1,1);
	wp_enqueue_script('manu15');

	wp_register_script('manu16',get_template_directory_uri() . '/assets/vendor/owl.carousel/owl.carousel.min.js',array(),1,1,1);
	wp_enqueue_script('manu16');

	wp_register_script('manu17',get_template_directory_uri() . '/assets/vendor/isotope-layout/isotope.pkgd.min.js',array(),1,1,1);
	wp_enqueue_script('manu17');

	wp_register_script('manu18',get_template_directory_uri() . '/assets/vendor/aos/aos.js',array(),1,1,1);
	wp_enqueue_script('manu18');

	wp_register_script('manu19',get_template_directory_uri() . '/assets/js/main.js',array(),1,1,1);
	wp_enqueue_script('manu19');

	wp_register_script('manu20',get_template_directory_uri() . '/',array(),1,1,1);
